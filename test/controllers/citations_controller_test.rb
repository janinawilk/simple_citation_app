...
class CitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citation" do
    assert_difference('Citation.count') do
      post citations_url, params: { citation: { author: @citation.author, citation: @citation.citation } }
    end
  ...
  test "should update citation" do
    patch citation_url(@citation), params: { citation: { author: @citation.author, citation: @citation.citation } }
